var PorcupineModule=require(__dirname+"/wasm/pv_porcupine.js");
let Porcupine = (function () {
    ...
    return {Loaded: Loaded(), create: create}
})();

/*
var fs=require("fs");

let lxf=Uint8Array.from(fs.readFileSync(__dirname+"/prekeywords/bumblebee_wasm.ppn"));
console.log(lxf)
Porcupine.Loaded.then(()=>{
	console.log(Porcupine.create([lxf],0.8))
	})*/
